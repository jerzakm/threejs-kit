...
import { SpritesheetFormat, constructSpriteMaterial, makeDataTexture } from './material'
...
export class InstancedSpriteMesh<T extends Material, V> extends InstancedUniformsMesh<T> {
  ...
  constructor(
    ...
    // display material
    const spriteMaterial = constructSpriteMaterial(baseMaterial, options?.geometry === 'tri')
